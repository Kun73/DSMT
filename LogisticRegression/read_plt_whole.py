...
def read_plt(graph_type, n_node, nt, step_tpye, iid, dataset):
    ...
    # zoomed in plot
    # ring 100
    # zoom_in_area = [5000, 8100, 4e-6, 3e-5]

    # ring 50
    zoom_in_area = [5000, 8100, 8e-6, 5e-5]
    # Create an inset_axes object (a smaller axes in the main plot)
    axins = inset_axes(ax, width="60%", height="30%", loc='upper right')
...
if __name__ == '__main__':
    read_plt('ring', 50, 10, 'constant', False, 'cifar10')